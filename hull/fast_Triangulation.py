...
class FastTriangulation:
    ...
    def fast_copy(self):
        ...
        new_triangulation.adj[:] = self.adj.copy()
        new_triangulation.edges = self.edges.copy()
    ...
    def flip(self, p1, p2):
        ...
        self.edges.discard((int(u_old), int(v_old)))
        ...
        #assert(self.find_face(p3, p1)!=None)
        #assert(self.find_face(p2, p3)!=None)
