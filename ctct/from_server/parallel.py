...
def read_dt(d, fcgs, fcgp1, fcgp2, rp, workers, dist):
    ...
    while True:
        ...
        #dt.new_center(fcgs, fcgp1, fcgp2, rp, workers, dist)
        dt.new_center2(fcgs, fcgp1, fcgp2, rp, workers, dist)
        count += 1
        if dt.dist < prev:
...
def get_parser():
    ...
    parser.add_argument('--dist', type=str, default='max')
...
if __name__=="__main__":
    ...
    if "json" in inp:
        read_dt(inp, fcgs, fcgp1, fcgp2, rp, workers, dist)
