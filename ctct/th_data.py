...
class Data:
    ...
    def ReadData(self):
        ...
        # print("--------------------ReadData--------------------")
            ...
            #f = open(self.input, "r", encoding="utf-8")
            org_input = "/Users/hyeyun/Experiment/PFD/hyeyun_git/data/benchmark_instances/"+self.instance_uid+".json"
            f = open(org_input, "r", encoding="utf-8")
            root = json.load(f)
            self.pts_x = root["points_x"]
            self.pts_y = root["points_y"]
            self.pts = []
    ...
    def flip_score2(self, tri:Triangulation, tri_dest:Triangulation, e:tuple, depth:int):
        ...
        if depth == 0:
            return (ori_cross, 0)
        new_cross = self.count_cross(tri_dest, (p2, p4))
        n_cross = (ori_cross - new_cross)/new_cross
        m_score = (n_cross, depth)
        # return m_score
        if depth == 1:
            return m_score
    ...
    def computePFS_total(self, T1, T2, tri_num):
        ...
        #if tri_num ==7:
        #    print("+++++1:")
        #    print(pFlips_paired1)
        #    print("++++11:")
        #    print(pFlips_paired11)
        #    print("++++2:")
        #    print(pFlips_paired2)
        #    print("++++21:")
        #    print(pFlips_paired21)
        #    print("++++3:")
        #    print(pFlips_paired3)
        #    print("++++31:")
        #    print(pFlips_paired31)
        #    print()
        #    print()
    ...
    def flip_rev(self, tri, e):
        ...
        i = t.get_ind(p)
        #print("t, e = ", t.pts,e, end=' ', flush=True)
            ...
            for i in range(len(self.triangulations)):
                ...
                for j in range(revnum[i]):
                    for e in self.pFlips[i][-j-1]:
                        ...
                        pi = t.get_ind(p)
                        #if i==7:
                        #    print("t, e, (p1, p2) = ", t.pts, e, (t.pt(pi+1), t.pt(pi+2)))
